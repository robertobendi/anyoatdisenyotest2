...
You are building the public face of **robertobendi/anyoatdisenyotest2** (modeled after https://www.facebook.com/anyoatdisenyo). Target: GitHub
...
1. **Per-page `<title>`** — unique + descriptive, e.g.
   `Services — Anyoatdisenyotest2`. Not just the site name on every page.
...
user can log into the local admin later):
    ...
    ADMIN_PASSWORD="bis-Kc0LZLNstlXBCD" \
    ADMIN_NAME="Admin" \
    SITE_NAME="Anyoatdisenyotest2" \
